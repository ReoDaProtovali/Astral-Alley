...
<<<<<<< HEAD:code/modules/mob/living/carbon/human/species/station/protean_vr/protean_rig.dm
					if(do_after(user,50,src,exclusive = TASK_ALL_EXCLUSIVE))
=======
					if(do_after(user, 5 SECONDS, target = src))
>>>>>>> 1b8f394a14 ([MIRROR] Makes uses of do_after sane (#11582)):code/modules/mob/living/carbon/human/species/station/protean/protean_rig.dm
