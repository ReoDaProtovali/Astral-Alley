...
<<<<<<< HEAD:modular_chomp/code/modules/mob/living/simple_animal/aliens/synx.dm
...
>>>>>>> 4febf95738 ([MIRROR] Simple mob port [IDB IGNORE] (#11492)):code/modules/mob/living/simple_mob/subtypes/animal/alien animals/synx.dm
