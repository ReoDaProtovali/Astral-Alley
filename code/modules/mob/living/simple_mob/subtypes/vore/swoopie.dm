...
<<<<<<< HEAD:modular_chomp/code/modules/mob/living/simple_mob/subtypes/vore/swoopie.dm
...
>>>>>>> 4febf95738 ([MIRROR] Simple mob port [IDB IGNORE] (#11492)):code/modules/mob/living/simple_mob/subtypes/vore/swoopie.dm
