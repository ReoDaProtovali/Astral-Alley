/obj/item/weapon/paper/carbon/cursedform
...
/obj/item/weapon/paper/carbon/cursedform/AltClick() // No fun.
	return

/obj/item/weapon/paper/carbon/cursedform/burnpaper(obj/item/weapon/flame/P, mob/user)
	var/class = "warning"
