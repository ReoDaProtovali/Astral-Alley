...
<<<<<<< HEAD:code/game/gamemodes/changeling/powers/rapid_regen.dm
		if(src.mind.changeling.recursive_enhancement)
			healing_amount = C.maxHealth
=======
		if(changeling.recursive_enhancement)
			healing_amount = C.getMaxHealth()
>>>>>>> a0c273ce1f ([MIRROR] Changing changeling (Refactor) (#11142)):code/datums/components/antags/changeling/powers/rapid_regen.dm
