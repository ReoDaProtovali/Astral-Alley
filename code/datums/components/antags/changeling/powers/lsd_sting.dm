...
<<<<<<< HEAD:code/game/gamemodes/changeling/powers/lsd_sting.dm
	return 1
=======
	return TRUE
>>>>>>> a0c273ce1f ([MIRROR] Changing changeling (Refactor) (#11142)):code/datums/components/antags/changeling/powers/lsd_sting.dm
