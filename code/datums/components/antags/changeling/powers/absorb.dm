...
<<<<<<< HEAD:code/game/gamemodes/changeling/powers/absorb.dm
...
>>>>>>> a0c273ce1f ([MIRROR] Changing changeling (Refactor) (#11142)):code/datums/components/antags/changeling/powers/absorb.dm
