...
<<<<<<< HEAD:modular_chomp/maps/southern_cross/overmap/shuttles.dm
	req_one_access = list(access_pilot)
=======
>>>>>>> 651c8bc1af ([MIRROR] Simultaneous map definitions (#10295)):modular_chomp/maps/common/common_overmap_shuttles.dm
