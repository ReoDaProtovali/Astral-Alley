...
/turf/simulated/floor/outdoors/desert_planet/mud/tyr
	...
	temperature	= TYR_AVG_TEMP
	outdoors = OUTDOORS_AREA
<<<<<<< HEAD:modular_chomp/maps/southern_cross/overmap/planets/tyr/tyr.dm
=======
...
/turf/simulated/shuttle/floor/voidcraft/tyr
	...
	temperature	= TYR_AVG_TEMP
	outdoors = OUTDOORS_AREA
>>>>>>> 651c8bc1af ([MIRROR] Simultaneous map definitions (#10295)):modular_chomp/maps/common_submaps/overmap/planets/tyr/tyr.dm
