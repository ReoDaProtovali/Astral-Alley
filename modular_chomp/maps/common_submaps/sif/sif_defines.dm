...
<<<<<<< HEAD:modular_chomp/maps/southern_cross/southern_cross_sif_defines.dm
/datum/planet/thor
	expected_z_levels = list(
		Z_LEVEL_JUNGLE
	)
...
>>>>>>> 651c8bc1af ([MIRROR] Simultaneous map definitions (#10295)):modular_chomp/maps/common_submaps/sif/sif_defines.dm
	teleport_x = src.x - 4
	teleport_y = src.y
	teleport_z = src.z
	return ..()
