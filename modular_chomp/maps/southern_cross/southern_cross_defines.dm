...
<<<<<<< HEAD:maps/southern_cross/southern_cross_defines.dm
/*
...
=======
>>>>>>> a5b8cb92d1 (Soluna Nexus map fixes 1.0 (#9276)):modular_chomp/maps/southern_cross/southern_cross_defines.dm
